...
public class TypeUtils
{
            ...
            implements ArrowTypeVisitor<Type>
    {
        ...
        @Override
        public Type visit(LargeBinary type)
        {
        	return VARBINARY;
            //throw new UnsupportedOperationException("LargeBinary type is not supported");
        }

        @Override
        public Type visit(LargeUtf8 type)
        {
        	return VARCHAR;
            //throw new UnsupportedOperationException("LargeUtf8 type is not supported");
        }

        @Override
        public Type visit(LargeList type)
        {
            throw new UnsupportedOperationException("LargeList type is not supported");
        }
