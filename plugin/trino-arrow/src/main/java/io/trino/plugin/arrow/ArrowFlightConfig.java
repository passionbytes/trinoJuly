...
import io.trino.plugin.arrow.location.LocationProviderType;
import jakarta.validation.constraints.NotNull;

import static io.airlift.units.DataSize.Unit.MEGABYTE;
import static io.trino.plugin.arrow.location.LocationProviderType.INSECURE;
...
public class ArrowFlightConfig
{
    ...
    private DataSize maxBufferSize = DataSize.of(16, MEGABYTE);
